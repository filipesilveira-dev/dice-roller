...
function App() {
  ...
  // controla o "disabled" dos botões enquanto os dados estão rolando: após o clique em "Rolar dados", seu valor se torna "true", desabilitando o botão
  ...
  // Função que soma todos os "value" dos dados no array "dice"
  const total = dices.reduce((sum, dice) => sum + (dice.value ?? 0), 0);
  ...
  return (
    <div className="app">
      ...
      {dices.length === 0 && <p className="no-dice-message">Nenhum dado adicionado</p>}
